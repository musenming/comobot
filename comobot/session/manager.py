...
from comobot.utils.helpers import ensure_dir, safe_filename
...
class SessionManager:
    ...
    def __init__(self, workspace: Path):
        ...
        self.legacy_sessions_dir = Path.home() / ".comobot" / "sessions"
    ...
    def _get_legacy_session_path(self, key: str) -> Path:
        """Legacy global session path (~/.comobot/sessions/)."""
        safe_key = safe_filename(key.replace(":", "_"))
