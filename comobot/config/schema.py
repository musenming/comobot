...
class TelegramConfig(Base):
    ...
    webhook_url: str = ""  # Webhook URL (e.g. "https://your-domain/webhook/telegram")
    secret_token: str = ""  # Webhook secret for X-Telegram-Bot-Api-Secret-Token verification
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.comobot/workspace"
...
class ProvidersConfig(Base):
    ...
    dashscope: ProviderConfig = Field(default_factory=ProviderConfig)  # 阿里云百炼平台 (DashScope)
