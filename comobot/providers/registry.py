...
class ProviderSpec:
    ...
    display_name: str = ""  # shown in `comobot status`
...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # DashScope / 百炼平台: Qwen models, needs "dashscope/" prefix.
    # API: https://dashscope.aliyuncs.com/compatible-mode/v1 (OpenAI-compatible)
    ProviderSpec(
        name="dashscope",
        keywords=("qwen", "dashscope", "bailian"),
