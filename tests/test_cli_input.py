...
from comobot.cli import commands
...
def mock_prompt_session():
    ...
    with (
        patch("comobot.cli.commands._PROMPT_SESSION", mock_session),
        patch("comobot.cli.commands.patch_stdout"),
    ):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with (
        patch("comobot.cli.commands.PromptSession") as mock_session,
        patch("comobot.cli.commands.FileHistory"),
